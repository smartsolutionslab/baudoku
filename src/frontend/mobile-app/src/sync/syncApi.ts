...
export async function initChunkedUpload(
  ...
  return apiPost<ChunkedUploadInitResult>('/api/documentation/uploads/init', {
    installationId,
    fileName,
    contentType,
    totalSize,
...
export async function uploadChunk(
  ...
  await apiRawUpload(`/api/documentation/uploads/${sessionId}/chunks/${chunkIndex}`, chunkBlob, {
