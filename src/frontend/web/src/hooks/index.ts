export { useApiQuery, useApiMutation, useApiPost, useApiPut, useApiDelete } from './useApiFactory';
export { useAuth } from './useAuth';
export { useGpsCapture } from './useGpsCapture';
export {
  useInstallations, useInstallation, useCreateInstallation, useUpdateInstallation, useDeleteInstallation,
  usePhotos, useUploadPhoto, useDeletePhoto,
