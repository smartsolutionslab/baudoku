...
public sealed class GpsPositionQualityTests
{
    ...
    {
        var position = GpsPosition.Create(48.0, 11.0, null, 0.5, "rtk");
    ...
    {
        var position = GpsPosition.Create(48.0, 11.0, null, 3.5, "internal_gps");
    ...
    {
        var position = GpsPosition.Create(48.0, 11.0, null, 15.0, "internal_gps");
    ...
    {
        var position = GpsPosition.Create(48.0, 11.0, null, 50.0, "internal_gps");
    ...
    public void CalculateQualityGrade_GoodSecondaryFactors_ShouldUpgradeByOneLevel()
    {
        ...
        var position = GpsPosition.Create(48.0, 11.0, null, 4.0, "dgnss",
    ...
    public void CalculateQualityGrade_AdjustmentCappedAtMinusOne()
    {
        ...
        var position = GpsPosition.Create(48.0, 11.0, null, 50.0, "dgnss",
