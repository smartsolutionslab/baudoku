...
public sealed class MeasurementValueExtendedTests
{
    ...
    {
        var value = MeasurementValue.Create(5.0, "mA");
    ...
    {
        var value = MeasurementValue.Create(5.0, "V", minThreshold: 1.0);
    ...
    {
        var value = MeasurementValue.Create(5.0, "V", maxThreshold: 10.0);
    ...
    {
        var act = () => MeasurementValue.Create(5.0, "");
